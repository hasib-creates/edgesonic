...
/// Lightweight wrapper around `mqtt_client` with sensible defaults for IoT use-cases.
/// Android build only: uses MqttServerClient (no web/browser client).
class MQTTService {
  MQTTService({
    ...
    this.useWebSocket = false, // Ignored on Android (kept for API compatibility)
  }) {
